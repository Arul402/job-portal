...
//   //   fetchData();
//   // }, [token, userType]); // Only re-fetch when token or userType changes
...
//           {userType === "company" ? (
//             <img
//               src={companyphoto || 'default-image.jpg'}
//               alt="Profile"
...
//         {/* <NavigationMenu className="flex flex-col space-y-2 list-none">
//           {userType === "company" ? (
//             <>
//             <NavigationMenuItem>
//                 <Link to="/recruiter" className={navigationMenuTriggerStyle()}>
//                   Home
//                 </Link>
//               </NavigationMenuItem>
//               <NavigationMenuItem>
//                 <Link to="/company-profile" className={navigationMenuTriggerStyle()}>
//                   Company Profile
//                 </Link>
//               </NavigationMenuItem>
//               <NavigationMenuItem>
...
//               </NavigationMenuItem>
//               <NavigationMenuItem>
//                 <Link to="/manage-jobs" className={navigationMenuTriggerStyle()}>
//                   Manage Jobs
//                 </Link>
//               </NavigationMenuItem>
//               <NavigationMenuItem>
//                 <Link to="/viewapplications" className={navigationMenuTriggerStyle()}>
//                   View Applications
//                 </Link>
//               </NavigationMenuItem>
//               <NavigationMenuItem>
//                 <Link to="/view-job" className={navigationMenuTriggerStyle()}>
//                   View Jobs
//                 </Link>
//               </NavigationMenuItem>
//               <NavigationMenuItem>
//             <Link to="/login" className="text-red-600 hover:underline" onClick={handleLogout}>
//               Logout
//             </Link>
//           </NavigationMenuItem>
//             </>
...
//             <>
//             <NavigationMenuItem>
//                 <Link to="/candidate" className={navigationMenuTriggerStyle()}>
//                   Home
//                 </Link>
//               </NavigationMenuItem>
//               <NavigationMenuItem>
...
//               </NavigationMenuItem>
//               <NavigationMenuItem>
//                 <Link to="/applied-jobs" className={navigationMenuTriggerStyle()}>
//                   Applied Jobs
//                 </Link>
//               </NavigationMenuItem>
//               <NavigationMenuItem>
...
//                   onClick={handleNavigateToEligibleJobs} // Reset badge when navigating here
//                 >
...
//         <>
//           <NavigationMenuItem>
//             <Link to="/recruiter" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               Home
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
//             <Link to="/company-profile" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               Company Profile
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
//             <Link to="/post-job" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               Post Jobs
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
//             <Link to="/manage-jobs" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               Manage Jobs
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
//             <Link to="/viewapplications" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               View Applications
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
//             <Link to="/view-job" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               View Jobs
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
//             <Link to="/login" className="text-red-600 hover:underline" onClick={() => { handleLogout(); handleLinkClick(); }}>
//               Logout
//             </Link>
//           </NavigationMenuItem>
//         </>
...
//         <>
//           <NavigationMenuItem>
//             <Link to="/candidate" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               Home
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
//             <Link to="/profile" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               Profile
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
//             <Link to="/applied-jobs" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               Applied Jobs
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
...
//               to="/eligible-jobs" 
//               className={navigationMenuTriggerStyle()} 
//               onClick={() => { handleNavigateToEligibleJobs(); handleLinkClick(); }}
//             >
//               Eligible Jobs {showBadge && <span className="badge4">{filteredJobs.length}</span>}
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
//             <Link to="/jobs" className={navigationMenuTriggerStyle()} onClick={handleLinkClick}>
//               Find Jobs
//             </Link>
//           </NavigationMenuItem>
//           <NavigationMenuItem>
