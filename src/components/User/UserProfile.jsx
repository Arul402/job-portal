...
className="iconbuttons"
   />   */}
   <img src={PersonImage} className="w-20 h-20" />
  ...
  <span className="text-lg">Resume, Profile Photo, and Username</span>  {/* Text kept as is */}
</Button>
...
>
  ...
  <img src={ToolsImage} className="w-20 h-20" />
...
>
  ...
  <img src={degreeImage} className="w-20 h-20" />
...
>
  ...
  <img src={SchoolImage} className="w-20 h-20" />
...
<Button
      ...
      >
        ...
        <img src={LockImage} className="w-20 h-20" />
