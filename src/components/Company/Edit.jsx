...
const Edit = () => {
    ...
    //     //   navigate('/manage-jobs', { replace: true }); // Redirect to jobs page after successful update
    //     // }
...
//   const [twelfthPercentageMin, setTwelfthPercentageMin] = useState("");
//   const [twelfthPercentageMax, setTwelfthPercentageMax] = useState("");
//   const [additionalDetails, setAdditionalDetails] = useState(""); // New field for additional details
//   const [loading, setLoading] = useState(false);
...
//         setUgCgpaMin(jobData.ug_cgpa_min);
//         setUgCgpaMax(jobData.ug_cgpa_max);
//         setTenthPercentageMin(jobData.tenth_percentage_min);
//         setTenthPercentageMax(jobData.tenth_percentage_max);
//         setTwelfthPercentageMin(jobData.twelfth_percentage_min);
//         setTwelfthPercentageMax(jobData.twelfth_percentage_max);
//         setAdditionalDetails(jobData.additional_details || ""); // Set additional details if present
//       } catch (error) {
...
//       twelfth_percentage_min: parseFloat(twelfthPercentageMin),
//       twelfth_percentage_max: parseFloat(twelfthPercentageMax),
//       additional_details: additionalDetails, // Include additionalDetails field
//     };
...
//       if (response.status === 200) {
//         setSubmissionStatus("Job updated successfully.");
//         navigate('/recruiter');
//       } else {
//         setSubmissionStatus("Failed to update job. Please try again.");
//       }
//     } catch (error) {
//       console.error("Error updating job:", error); // Log the error object
...
//   return (
//     <Drawer open={true} onOpenChange={handleDrawerClose}>
//       <DrawerContent>
//         <DrawerHeader>
//           <DrawerTitle>Edit Job</DrawerTitle>
//         </DrawerHeader>
...
//         <ScrollArea className="h-[calc(100vh-150px)] overflow-y-auto">
//           <form onSubmit={handleJobUpdate} className="space-y-4 p-4">
//             <Input placeholder="Job Title" value={title} onChange={(e) => setTitle(e.target.value)} required />
//             <Textarea placeholder="Job Description" value={description} onChange={(e) => setDescription(e.target.value)} required />
//             <Input placeholder="Location" value={location} onChange={(e) => setLocation(e.target.value)} required />
