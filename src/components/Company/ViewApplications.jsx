...
//       if (token) {
//         try {
//           const profileResponse = await axios.get(`${config.base_url2}/api/v1/app/manage-company-profile/`, {
//             headers: {
...
//       try {
//         const response = await axios.get(`${config.base_url2}/api/v1/app/applications/all/`, {
//           headers: {
//             'Authorization': `Token ${token}`,
//           },
//         });
...
//     try {
//       await axios.patch(
//         `${config.base_url2}/api/v1/app/applications/${applicationId}/update-status/`,
//         { status },
//         {
//           headers: {
//             'Authorization': `Token ${token}`,
...
//                   <a href={`${config.base_url2}${application.resume}`} target="_blank" rel="noopener noreferrer">
//                     View Resume
//                   </a>
//                 </Button>
